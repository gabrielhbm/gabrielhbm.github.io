...
const Projects = () => {
  ...
  const projectData = [
    ...
    { id: 3, name: t('travelManagerProject'), description: [t('travelManagerDescOne'), t('travelManagerDescTwo')], skills: ['java', 'androidstudio', 'kotlin', 'sqlite', 'azuresqldatabase', 'figma'], date: '2024', img: 'img/travelmanager.png' },
